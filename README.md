...
## 5. Выгорание
5.1 Для запуска расчётов на выгорание необходимо дополнительно скачать файл с цепочками распада. Эти файлы для разных спектров и разных версий библиотеки можно найти здесь: https://openmc.org/data/#endf-b-vii-1-chain-thermal-spectrum . Скачайте его и поместите в директорию `jupyter`.

5.2 Добавьте путь к скачанному файлу в конфигурацию библиотеки. Это можно сделать либо задав переменную окружения `OPENMC_CROSS_SECTIONS = <название_вашего_файла>`, либо добавив в ячейку с импортом библиотеки строчку `openmc.config['chain_file'] = '<название_вашего_файла>'`.
